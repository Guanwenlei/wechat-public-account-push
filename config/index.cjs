...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小公主', year: '2002', date: '10-01',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '公主的骑士', year: '1999', date: '04-21',
        },
        {
          type: '节日', name: '相识纪念日', year: '2023', date: '01-10',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
        ...
        // 结婚纪念日
        { keyword: 'marry_day', date: '2023-01-10' },
      ],
    },
  ],
  ...
  CALLBACK_TEMPLATE_ID: 'bTFOw2JI3GEDIcpJkeB3jUKLfGe7Gzp-g9N8KM_OR24',
